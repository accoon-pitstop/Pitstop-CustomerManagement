using Accoon.Pitshop.CustomerApi.Presenter.Infastructure;
using Accoon.Pitshop.CustomerApi.Presenter.Middlewares;
using Accoon.Pitshop.CustomerApi.Application.Infastructure.Automapper;
...
namespace Accoon.Pitshop.CustomerApi.Presenter
{
